...
public class ItemListUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableItem.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item ID", "Item Name", "Manufacturing Date", "Expiry Date", "Price"
            }
        ));
...
while (rs.next())
{
    ...
    mandate = rs.getDate(3);
    expdate = rs.getDate(4);
    double price = rs.getDouble(5);
    model.addRow(new Object[]{itemid,itemname,mandate,expdate,price});
}
}
catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ItemListUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
