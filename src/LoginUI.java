...
public class LoginUI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
             ...
             ResultSet rs= stmt.executeQuery("select * from login where userid = '"+userid+"' && password = '"+pass+"';");
             if(rs.next())
             { MainUI field=new MainUI();
             field.setVisible(true);
             this.setVisible(false);
             }
            else
            {JOptionPane.showMessageDialog(null,"User id and Password doesn't match");
            }
            rs.close();
            stmt.close();
            conn.close();
